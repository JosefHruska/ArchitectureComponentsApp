...
class ProgressLine @JvmOverloads constructor(context: Context, attrs: AttributeSet, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    private var mValueText = "6,0090"
    private var mDefText = "daily steps"
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val startX_U = endX_P + widthPaddingBetweenBars
        val endX_U = startX_U + mBarLenght * (1 - mScale)
        canvas.drawLine(
                startX_U,
    ...
    fun setPercentage(percetage: Int) {
